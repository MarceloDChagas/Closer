...
exports.PHOTO_PACKAGES = exports.EPhotoSessionCategory = void 0;
exports.getPackagesByCategory = getPackagesByCategory;
exports.getPackageById = getPackageById;
exports.getPackagesByLocation = getPackagesByLocation;
exports.getPackagesByPriceRange = getPackagesByPriceRange;
const EPhotoSessionCategory_1 = require("../enums/EPhotoSessionCategory");
Object.defineProperty(exports, "EPhotoSessionCategory", { enumerable: true, get: function () { return EPhotoSessionCategory_1.EPhotoSessionCategory; } });
exports.PHOTO_PACKAGES = [
    {
        id: "mothers-basic",
        name: "Pacote 1 - Dia das Mães",
        category: EPhotoSessionCategory_1.EPhotoSessionCategory.MOTHERS_DAY,
    ...
    },
    {
        ...
        category: EPhotoSessionCategory_1.EPhotoSessionCategory.FAMILY,
    ...
    },
    {
        id: "baby-newborn",
        name: "Ensaio Newborn",
        category: EPhotoSessionCategory_1.EPhotoSessionCategory.BABY,
    ...
    },
    {
        ...
        name: "Smash the Cake",
        category: EPhotoSessionCategory_1.EPhotoSessionCategory.BIRTHDAY,
...
function getPackagesByCategory(category) {
    return exports.PHOTO_PACKAGES.filter((pkg) => pkg.category === category);
}
function getPackageById(id) {
    return exports.PHOTO_PACKAGES.find((pkg) => pkg.id === id);
}
function getPackagesByLocation(location) {
    return exports.PHOTO_PACKAGES.filter((pkg) => pkg.location === location);
}
function getPackagesByPriceRange(minPrice, maxPrice) {
    return exports.PHOTO_PACKAGES.filter((pkg) => pkg.price >= minPrice && pkg.price <= maxPrice);
}
//# sourceMappingURL=PhotoPackages.js.map